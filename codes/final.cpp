...
////Detect Checkpoints///
  if (checkpoint(IR_D_val)) {
    ...
    if (stage == 1) {
      ...
      Serial.println(getDistance(trigPin_FL, echoPin_FL));
      Serial.print("left");
      Serial.println(getDistance(trigPin_L, echoPin_L));
      Serial.print("mid");
      Serial.println(getDistance(trigPin_M, echoPin_M));
      Serial.print("right");
      Serial.println(getDistance(trigPin_R, echoPin_R));
